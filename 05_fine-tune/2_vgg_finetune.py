...
"""
A simple example about how to use fine-tune technology.

In general, the steps of using fine-tune:
1. save models (third_party or yourself)
2. restore model from checkpoint file
...
def main():
    ...
    with tf.Session() as sess:
        ...
        if os.path.exists(model_path + '.data-00000-of-00001') and \
            ...
            raise Exception("[ERROR] model does not exists!!!")
